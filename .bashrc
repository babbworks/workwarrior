...
case "$1" in
  service)
    shift
    "$HOME/ww/tools/new-service.sh" "$@"
    ;;
  *)
    echo "Usage: new <subcommand>"
    echo "Available subcommands:"
    echo "  service    Create a new Workwarrior service"
    ;;
esac
...
# -- Lists ---
alias Time='/Users/mp/ww/profiles/sept25/.timewarrior'
alias List='/Users/mp/ww/profiles/sept25/todo/sept25_default.todo'
alias Work='/Users/mp/ww/profiles/sept25/.taskrc'
...
# -- Books ---
alias ledger='hledger -f "/Users/mp/ww/profiles/sept25/ledgers/sept25.journal"'
alias Workbook='hledger -f "/Users/mp/ww/profiles/sept25/ledgers/sept25.journal"'
alias journal='jrnl --config-file "/Users/mp/ww/profiles/sept25/jrnl.yaml"'
alias Notebook='jrnl --config-file "/Users/mp/ww/profiles/sept25/jrnl.yaml"'
...
# Added by Mister command line master
alias m='mister'
alias ml='mister list'
alias mr='mister run'
alias ms='mister status'
alias hey='mister'
# END MISTER CONFIGURATION

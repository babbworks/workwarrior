...
show_installation_overview() {
  ...
  echo ""
  echo "  1. Check/install external dependencies"
  echo "     • TaskWarrior, TimeWarrior, Hledger, JRNL"
  echo ""
  echo "     Bundled tools (included):"
  echo "     • list - Simple list manager"
  echo ""
  echo "  2. Install workwarrior to ~/ww"
  echo "     • bin/     - ww command"
  echo "     • lib/     - core libraries"
  echo "     • scripts/ - profile management"
  echo "     • services/ - service registry"
  echo "     • tools/   - bundled utilities (list)"
  echo ""
  echo "  3. Configure shell integration"
  echo "     • Add ww to PATH"
  echo "     • Enable profile activation"
  echo ""
}

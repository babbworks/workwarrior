...
check "Explorer A report exists" "ls \"${CODEX_ROOT}/audits\"/*explorer-a* >/dev/null 2>&1"
check "Explorer B report exists" "ls \"${CODEX_ROOT}/audits\"/*explorer-b* >/dev/null 2>&1"

...
- [ ] `devsystem/codex/v2/` directory exists with full architecture
...
```bash
cp devsystem/codex/v2/CLAUDE.md CLAUDE.md
```
...
```bash
cp devsystem/codex/v2/services-CLAUDE.md services/CLAUDE.md
```
...
- Output: `devsystem/codex/v2/outputs/explorer-a-report.md`
...
Key parameters:
- No worktree (read-only)
- Output: `devsystem/codex/v2/outputs/explorer-b-report.md`

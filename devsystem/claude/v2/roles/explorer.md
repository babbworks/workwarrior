...
- **Output goes to `devsystem/claude/v2/outputs/`.** Not to project files.
...
Write your output to devsystem/claude/v2/outputs/explorer-a-report.md
Use the template at devsystem/claude/v2/templates/explorer-a-output.md.
...
Write output to devsystem/claude/v2/outputs/explorer-b-report.md
Use the template at devsystem/claude/v2/templates/explorer-b-output.md.

...
- [ ] `devsystem/claude/v2/` directory exists with full architecture
...
```bash
cp devsystem/claude/v2/CLAUDE.md CLAUDE.md
```
...
```bash
cp devsystem/claude/v2/services-CLAUDE.md services/CLAUDE.md
```
...
- Output: `devsystem/claude/v2/outputs/explorer-a-report.md`
...
Key parameters:
- No worktree (read-only)
- Output: `devsystem/claude/v2/outputs/explorer-b-report.md`

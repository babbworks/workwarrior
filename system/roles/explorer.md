...
- **Output goes to `system/outputs/`.** Not to project files.
...
Write your output to system/outputs/explorer-a-report.md
...
Write output to system/outputs/explorer-b-report.md

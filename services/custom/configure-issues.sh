...
show_banner() {
  echo ""
  echo "============================================================"
  echo "         Issues & GitHub Sync Configuration"
  echo "============================================================"
  echo ""
  echo "  GitHub Integration (recommended starting point):"
  echo "    Two-way sync  →  i push / i sync / i enable-sync"
  echo "    One-way pull  →  i pull  (bugwarrior)"
  echo ""
  echo "  Other services (GitLab, Jira, Trello, and 20+ more):"
  echo "    One-way pull only via bugwarrior: i pull"
  echo ""
  echo "  ⚠️  Bugwarrior is one-way: external services → TaskWarrior"
